...
let LegacyBase = HTMLElement;
if (window.ShadyDOM && window.ShadyDOM.patchOnDemand) {
  LegacyBase = class extends HTMLElement {}
  ShadyDOM.patchElementProto(LegacyBase.prototype);
}
...
export const Class = function(info, mixin) {
  ...
  let klass = mixin ? mixin(LegacyElementMixin(LegacyBase)) :
      LegacyElementMixin(LegacyBase);

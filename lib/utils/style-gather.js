...
import { allowTemplateFromDomModule, strictTemplatePolicy } from './settings.js';
...
function domModuleStyleIncludesAllowed() {
  return !strictTemplatePolicy || allowTemplateFromDomModule;
}
...
function importModule(moduleId) {
  if (!domModuleStyleIncludesAllowed()) {
    return null;
  }

...
## [Unreleased](https://github.com/Polymer/polymer/tree/HEAD)

[Full Changelog](https://github.com/Polymer/polymer/compare/v1.0.3...HEAD)
...
- Orphan elements when the data updates [\#1789](https://github.com/Polymer/polymer/issues/1789)
...
- property initialization/declaration order arbitrarily throws errors in computed value definitions using `this` [\#1776](https://github.com/Polymer/polymer/issues/1776)

- Nuances involving async operations & the use of Polymer.dom.flush\(\) seemingly benefits having a code snippet provided \(DOM API Docs\)  [\#1775](https://github.com/Polymer/polymer/issues/1775)

- Minor typo: Docs do not explicitly state the naming conventions they need to use for their Web Components to not be an HTMLUnkownElement [\#1774](https://github.com/Polymer/polymer/issues/1774)
...
- missing " [\#1662](https://github.com/Polymer/polymer/issues/1662)

- Use consistent name for bower\_components folder [\#1651](https://github.com/Polymer/polymer/issues/1651)
...
- \[0.8\] Ready callback and element initialization [\#1467](https://github.com/Polymer/polymer/issues/1467)
...
[Full Changelog](https://github.com/Polymer/polymer/compare/v1.0.2...v1.0.3)
...
- Weird Polymer Catalog Bug \(Md\) -- "paper-toast" [\#1678](https://github.com/Polymer/polymer/issues/1678)
...
- when i pass params in element is not readable inside the element  [\#1669](https://github.com/Polymer/polymer/issues/1669)
...
- \[1.0\] extends native element and "is" attribute [\#1659](https://github.com/Polymer/polymer/issues/1659)
...
- \[0.9\] Documentation issue \(dom-repeat\) [\#1608](https://github.com/Polymer/polymer/issues/1608)
...
[Full Changelog](https://github.com/Polymer/polymer/compare/v1.0.1...v1.0.2)

## [v1.0.1](https://github.com/Polymer/polymer/tree/v1.0.1) (2015-05-29)

[Full Changelog](https://github.com/Polymer/polymer/compare/v1.0.0...v1.0.1)
...
- \[0.8\] 'Polymer' undefined in Polymer.Base assignment [\#1408](https://github.com/Polymer/polymer/issues/1408)
...
[Full Changelog](https://github.com/Polymer/polymer/compare/v0.9.4...v1.0.0)
...
[Full Changelog](https://github.com/Polymer/polymer/compare/v0.9.3...v0.9.4)
...
[Full Changelog](https://github.com/Polymer/polymer/compare/v0.9.2...v0.9.3)
...
[Full Changelog](https://github.com/Polymer/polymer/compare/v0.9.1...v0.9.2)
...
[Full Changelog](https://github.com/Polymer/polymer/compare/v0.9.0...v0.9.1)
...
- Update comments for hostAttribute [\#1560](https://github.com/Polymer/polymer/issues/1560)
...
- \[0.9\] documentation issue - horizontal scrolling broken on code views [\#1545](https://github.com/Polymer/polymer/issues/1545)
...
[Full Changelog](https://github.com/Polymer/polymer/compare/v0.9.0-rc.1...v0.9.0)
...
[Full Changelog](https://github.com/Polymer/polymer/compare/0.5.6...v0.9.0-rc.1)
...
[Full Changelog](https://github.com/Polymer/polymer/compare/v0.8.0-rc.7...0.5.6)
...
[Full Changelog](https://github.com/Polymer/polymer/compare/v0.8.0-rc.6...v0.8.0-rc.7)
...
[Full Changelog](https://github.com/Polymer/polymer/compare/v0.8.0-rc.5...v0.8.0-rc.6)

## [v0.8.0-rc.5](https://github.com/Polymer/polymer/tree/v0.8.0-rc.5) (2015-04-20)

[Full Changelog](https://github.com/Polymer/polymer/compare/v0.8.0-rc.4...v0.8.0-rc.5)
...
[Full Changelog](https://github.com/Polymer/polymer/compare/v0.8.0-rc.3...v0.8.0-rc.4)

## [v0.8.0-rc.3](https://github.com/Polymer/polymer/tree/v0.8.0-rc.3) (2015-04-09)

[Full Changelog](https://github.com/Polymer/polymer/compare/v0.8.0-rc.2...v0.8.0-rc.3)
...
[Full Changelog](https://github.com/Polymer/polymer/compare/v0.8.0...v0.8.0-rc.2)
...
[Full Changelog](https://github.com/Polymer/polymer/compare/v0.8.0-rc.1...v0.8.0)
...
[Full Changelog](https://github.com/Polymer/polymer/compare/0.5.5...v0.8.0-rc.1)
...
[Full Changelog](https://github.com/Polymer/polymer/compare/0.5.5-rc1...0.5.5)
...
[Full Changelog](https://github.com/Polymer/polymer/compare/0.5.4...0.5.5-rc1)
...
[Full Changelog](https://github.com/Polymer/polymer/compare/0.5.3...0.5.4)
...
[Full Changelog](https://github.com/Polymer/polymer/compare/0.5.3-rc2...0.5.3)

## [0.5.3-rc2](https://github.com/Polymer/polymer/tree/0.5.3-rc2) (2015-01-21)

[Full Changelog](https://github.com/Polymer/polymer/compare/0.5.3-rc...0.5.3-rc2)
...
[Full Changelog](https://github.com/Polymer/polymer/compare/0.5.2...0.5.3-rc)
...
[Full Changelog](https://github.com/Polymer/polymer/compare/0.5.1...0.5.2)
...
[Full Changelog](https://github.com/Polymer/polymer/compare/0.5.0...0.5.1)
...
[Full Changelog](https://github.com/Polymer/polymer/compare/0.4.2...0.5.0)
...
- External CSS in Polymer Elements is ignored in Chrome Extensions [\#779](https://github.com/Polymer/polymer/issues/779)
...
- Polymers elements cannot go fullscreen [\#745](https://github.com/Polymer/polymer/issues/745)
...
[Full Changelog](https://github.com/Polymer/polymer/compare/0.3.6...0.4.2)
...
[Full Changelog](https://github.com/Polymer/polymer/compare/0.4.1...0.3.6)

## [0.4.1](https://github.com/Polymer/polymer/tree/0.4.1) (2014-09-18)

[Full Changelog](https://github.com/Polymer/polymer/compare/0.4.0...0.4.1)
...
[Full Changelog](https://github.com/Polymer/polymer/compare/0.3.5...0.4.0)
...
- Invalid Link in Docs to ICONSET [\#449](https://github.com/Polymer/polymer/issues/449)
...
[Full Changelog](https://github.com/Polymer/polymer/compare/0.3.4...0.3.5)
...
- core-pages example missing a closing parenthesis [\#654](https://github.com/Polymer/polymer/issues/654)
...
- post-service can't load when running demo app from Visual Studio / IIS [\#633](https://github.com/Polymer/polymer/issues/633)
...
[Full Changelog](https://github.com/Polymer/polymer/compare/0.3.3...0.3.4)
...
[Full Changelog](https://github.com/Polymer/polymer/compare/0.3.2...0.3.3)
...
[Full Changelog](https://github.com/Polymer/polymer/compare/0.3.1...0.3.2)
...
[Full Changelog](https://github.com/Polymer/polymer/compare/0.3.0...0.3.1)
...
[Full Changelog](https://github.com/Polymer/polymer/compare/0.2.4...0.3.0)
...
[Full Changelog](https://github.com/Polymer/polymer/compare/0.2.3...0.2.4)
...
[Full Changelog](https://github.com/Polymer/polymer/compare/0.2.2...0.2.3)
...
[Full Changelog](https://github.com/Polymer/polymer/compare/0.2.1...0.2.2)
...
[Full Changelog](https://github.com/Polymer/polymer/compare/0.2.0...0.2.1)
...
[Full Changelog](https://github.com/Polymer/polymer/compare/0.1.4...0.2.0)
...
[Full Changelog](https://github.com/Polymer/polymer/compare/0.1.3...0.1.4)
...
[Full Changelog](https://github.com/Polymer/polymer/compare/0.1.2...0.1.3)
...
[Full Changelog](https://github.com/Polymer/polymer/compare/0.1.1...0.1.2)
...
[Full Changelog](https://github.com/Polymer/polymer/compare/0.1.0...0.1.1)
...
[Full Changelog](https://github.com/Polymer/polymer/compare/v0.0.20131107...0.1.0)
...
[Full Changelog](https://github.com/Polymer/polymer/compare/v0.0.20131025...v0.0.20131107)
...
[Full Changelog](https://github.com/Polymer/polymer/compare/v0.0.20131010...v0.0.20131025)
...
[Full Changelog](https://github.com/Polymer/polymer/compare/v0.0.20131003...v0.0.20131010)
...
[Full Changelog](https://github.com/Polymer/polymer/compare/v0.0.20130912...v0.0.20131003)
...
[Full Changelog](https://github.com/Polymer/polymer/compare/v0.0.20130905...v0.0.20130912)
...
[Full Changelog](https://github.com/Polymer/polymer/compare/v0.0.20130829...v0.0.20130905)
...
[Full Changelog](https://github.com/Polymer/polymer/compare/v0.0.20130816...v0.0.20130829)
...
[Full Changelog](https://github.com/Polymer/polymer/compare/v0.0.20130815...v0.0.20130816)

## [v0.0.20130815](https://github.com/Polymer/polymer/tree/v0.0.20130815) (2013-08-15)

[Full Changelog](https://github.com/Polymer/polymer/compare/v0.0.20130808...v0.0.20130815)
...
[Full Changelog](https://github.com/Polymer/polymer/compare/v0.0.20130801...v0.0.20130808)
...
[Full Changelog](https://github.com/Polymer/polymer/compare/v0.0.20130711...v0.0.20130801)
